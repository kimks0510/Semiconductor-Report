...
Register-ScheduledTask -TaskName $TaskName -Action $action -Trigger $trigger -Settings $settings -Principal $principal -Description 'Weekday 8 AM semiconductor briefing and Kakao delivery' -Force
